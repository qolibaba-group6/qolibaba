...
const (
	CompanyService_GetCompany_FullMethodName    = "/companies.CompanyService/GetCompany"
	CompanyService_CreateCompany_FullMethodName = "/companies.CompanyService/CreateCompany"
)
...
type CompanyServiceClient interface {
	...
	CreateCompany(ctx context.Context, in *NewCompany, opts ...grpc.CallOption) (*CompanyResponse, error)
}
...
func (c *companyServiceClient) CreateCompany(ctx context.Context, in *NewCompany, opts ...grpc.CallOption) (*CompanyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CompanyResponse)
...
type CompanyServiceServer interface {
	...
	CreateCompany(context.Context, *NewCompany) (*CompanyResponse, error)
...
func (UnimplementedCompanyServiceServer) CreateCompany(context.Context, *NewCompany) (*CompanyResponse, error) {
...
var CompanyService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/company_service.proto",
}
